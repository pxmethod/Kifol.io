...
export class EndorsementService {
  ...
  /**
   * Accepts browser, SSR, or service-role clients. They differ in @supabase/* generic arity;
   * we normalize once here so call sites stay simple.
   */
  constructor(client: unknown) {
    this.supabase = client as SupabaseClient<Database>
  }
