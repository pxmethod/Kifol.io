...
import { generateToken } from '@kifolio/utils'
import { EndorsementService } from '@kifolio/database';
import { sendEndorsementRequestEmail } from '@kifolio/emails';
import { getAppUrl } from '@kifolio/utils';
...
async function fetchHighlightForEndorsement(
  supabase: Awaited<ReturnType<typeof import('@kifolio/supabase/server').createClient>>,
