...
export default function HighlightCard({
      ...
      <div className="flex flex-wrap items-center gap-2 mt-2">
        {hasImages && (
          <div className="flex items-center space-x-1">
            <svg className="w-4 h-4 text-discovery-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div
      className={`bg-discovery-white-100 rounded-lg shadow-md p-4 transition-all duration-200 relative ${
