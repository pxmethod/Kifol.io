        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-discovery-grey leading-relaxed">
              ...
              <Link href="/auth/login" className="text-discovery-orange hover:text-discovery-orange-light font-medium">
                Log in
              </Link>
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <p className="text-md font-medium text-discovery-grey leading-relaxed">Password requirements:</p>
            ...
            {/* Legal Links */}
            <div className="mt-6 text-center text-xs text-discovery-grey">
              By creating an account, you agree to our{' '}
              <Link href="/terms" className="text-discovery-orange hover:text-discovery-orange-light">
                Terms of Use
              </Link>
              {' '}and{' '}
              <Link href="/privacy" className="text-discovery-orange hover:text-discovery-orange-light">
                Privacy Policy
              </Link>
            </div>
          </div>
